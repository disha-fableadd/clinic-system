    ...
    <div class="content" style="height:100vh">
        <div class="row">
            <div class="col-sm-8 col-8">
                <h4 class="page-title" style="text-align:left; !important">All Inventory Details</h4>
            </div>
            ...
            <div class="col-md-12">
                <div class="card" >
                    <div class="card-header"
                        ...
                        <h3 class="card-title d-inline-block text-white"><i class="fa fa-calendar px-2" style="font-size:20px"></i>All Inventory </h3>
