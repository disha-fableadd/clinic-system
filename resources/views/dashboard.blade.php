            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="dash-widget1">
                        ...
                        <div class="dash-widget-info text-right">
                            ...
                            <h3 class="total-users-count">0</h3>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="dash-widget2">
                        ...
                        <div class="dash-widget-info text-right">
                            ...
                            <h3 class="total-doctors-count">0</h3>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="dash-widget1">
                        ...
                        <div class="dash-widget-info text-right">
                            ...
                            <h3 class="total-patient-count">0</h3>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="dash-widget2" style="padding:20px 19px 20px 20px">
                        ...
                        <div class="dash-widget-info text-right">
                            <span class="widget-title2 mb-3"> Appointment </span>
                            <h3 class="total-appointment-count">0</h3>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                    <div class="dash-widget1">
                        <span class="dash-widget-bg1"><i class="fa fa-user-md" aria-hidden="true"></i></span>
                        <div class="dash-widget-info text-right">
                            <span class="widget-title1">Appointment </span>
                            <h3>98</h3>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                    <div class="dash-widget2">
                        <span class="dash-widget-bg2"><i class="fa fa-stethoscope" aria-hidden="true"></i> </span>
                        <div class="dash-widget-info text-right">
                            <span class="widget-title2 mb-3"> Medicines </span>
                            <h3>1072</h3>
                ...
                <div class="col-12 col-md-6 col-lg-6 col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="chart-title">
                                <div>
                                    <h4><i class="fa fa-user-md icon-style1" aria-hidden="true"></i>Patients</h4>
                                    <span class="float-right"><i class="fa fa-caret-up" aria-hidden="true"></i> 15% Higher
                                        than
                                        Last Month</span>
                                    <div class="chart-container">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            url: '/api/total-users', // API endpoint
            method: 'GET',
            headers: { "Authorization": "Bearer " + localStorage.getItem('token') }, // If authentication is needed
            success: function (response) {
                $('.total-users-count').text(response.total_users); // Update the count dynamically
            },
        ...
        $.ajax({
            url: '/api/total-patient', // API endpoint
            method: 'GET',
            headers: { "Authorization": "Bearer " + localStorage.getItem('token') }, // If authentication is needed
            success: function (response) {
                $('.total-patient-count').text(response.total_patient); // Update the count dynamically
            },
            error: function (error) {
                console.log('Error fetching total users:', error);
            }
        ...
        $.ajax({
            url: '/api/total-appointment', // API endpoint
            method: 'GET',
            headers: { "Authorization": "Bearer " + localStorage.getItem('token') }, // If authentication is needed
            success: function (response) {
                $('.total-appointment-count').text(response.total_appointment); // Update the count dynamically
            },
            error: function (error) {
                console.log('Error fetching total users:', error);
            }
        ...
        $.ajax({
            url: '/api/total-doctors', // API endpoint
            method: 'GET',
            headers: { "Authorization": "Bearer " + localStorage.getItem('token') }, // If authentication is needed
            success: function (response) {
                $('.total-doctors-count').text(response.total_doctors); // Update the count dynamically
            },
            error: function (error) {
