                                    ...
                                    <ul style="{{ request()->routeIs('supplier.*') ? 'display: block;' : 'display: none;' }}">
                                        @if(app('hasPermission')(35, 'view'))
                                            <li class="menu-link1 {{ request()->routeIs('supplier.index') ? 'active' : '' }} mt-1">
                                                <a href="{{ route('supplier.index') }}"><i class="fa fa-truck icons"></i><span style="
                                        ...
                                        @if(app('hasPermission')(35, 'create'))
                                                                <li class="menu-link1 {{ request()->routeIs('supplier.create') ? 'active' : '' }} mt-1">
                                                                    <a href="{{ route('supplier.create') }}"><i class="fa fa-plus-circle icons"></i><span style="
