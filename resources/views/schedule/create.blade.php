    ...
    <div class="content" style="height:100vh; !important">
        <div class="row">
            ...
            <div class="col-sm-6 col-5">
                <h4 class="page-title" style="text-align:center; margin-right: 120px ;!important">Add Schedule</h4>
            </div>
            <div class="col-sm-6 col-7 text-center m-b-2 ">
                <a href="{{ route('schedule.index') }}" class="btn btn-primary  btn-rounded" style="margin-left: 200px;">
