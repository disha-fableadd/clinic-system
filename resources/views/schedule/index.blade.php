    ...
    <div class="content" style="height:100vh">
        <div class="row">
            <div class="col-sm-4 col-3">
                <h4 class="page-title" style="text-align:left; !important">All Schedule</h4>
            </div>
            <div class="col-sm-8 col-9 text-right m-b-2 ">
                <a href="{{ route('schedule.create') }}" class="btn btn-primary  btn-rounded"><i class="fa fa-plus"></i>
                    Add Schedule</a>
            </div>
        </div>
        <div class="row filter-row">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Search schedule..">
